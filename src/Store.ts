...
import { FantasyGold, FantasyGoldRPC, Contract } from "fantasygoldjs"

import { ITransferLog, ITxRecord } from "./types"
import { TxRecord } from "./views/TxRecord"

// FGC_RPC defined in config/[env].js
// SOLAR_REPO is `solar.[env].json`. defined in config/*.js
const FGC_RPC = "http://localhost:9888"
import * as repo from "../solar.json"

const fantasygold = new FantasyGold(FGC_RPC, repo as any)
const myToken = fantasygold.contract("zeppelin-solidity/contracts/token/ERC20/CappedToken.sol")
